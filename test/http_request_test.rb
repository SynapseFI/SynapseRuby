...
class HTTPClientTest < Minitest::Test
  ...
  def test_base_url
    @http_request = Synapse::HTTPClient.new(base_url: @options[:base_url] , client_id: @options[:client_id], client_secret: @options[:client_secret], fingerprint: @options[:fingerprint], ip_address: @options[:ip_address])
  ...
  def test_config_exists_and_returns_a_hash
    @http_request = @client = Synapse::HTTPClient.new(base_url: @options[:base_url] , client_id: @options[:client_id], client_secret: @options[:client_secret], fingerprint: @options[:fingerprint], ip_address: @options[:ip_address])
