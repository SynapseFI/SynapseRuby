...
module Synapse
  ...
  class Client
    ...
    def get_users(**options)
      ...
      users = response['users'].map do |user_data|
        User.new(user_id: user_data['_id'],
    ...
    def get_all_subscriptions(**options)
      ...
      response = subscriptions['subscriptions'].map do |subscription_data|
        Subscription.new(subscription_id: subscription_data['_id'],
